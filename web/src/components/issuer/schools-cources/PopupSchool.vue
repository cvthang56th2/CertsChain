        ...
        <div class="flex">
          ...
          <div class="px-4 py-2 border-b-2 w-2/3 flex items-center">
            <div class="w-1/4">
              ...
              <input v-model="courceObj.name" class="border-b-2 p-1 max-w-full" type="text" name="name" placeholder="Name...">
            </div>
            <div class="w-1/4 pl-2">
              <label class="font-semibold">Description</label>
              <textarea v-model="courceObj.description" class="border-b-2 p-1 max-w-full" name="Description" placeholder="Description..."></textarea>
            </div>
            <div class="w-1/4 pl-2">
              <label class="font-semibold">Time</label>
              <input v-model="courceObj.time" class="border-b-2 p-1 max-w-full" type="text" name="time" placeholder="Time...">
            </div>
            <div class="w-1/4 pl-2">
